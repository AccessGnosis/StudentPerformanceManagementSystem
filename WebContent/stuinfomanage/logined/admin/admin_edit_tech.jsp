...
<title>修改教师信息 —— 欢迎来到学生信息管理系统 —— 管理员登录</title>
...
<body>
	<%
		...
		teacher = TeacherDAO.getTeacher(uid);
	%>
	<div class="container">
					...
					<form action="AdminUpdateTeacher" method="post">
						<div class="col-md-6 column">
							<label>工号</label> <input type="text" class="form-control"
								value="<%out.print(teacher.getTid());%>" name="tid"> <br>
							...
							<br> <label>学历</label> <input type="text"
								class="form-control"
								value="<%out.print(teacher.getTedubag());%>" name="tedubag">
							<br> <label>职称</label> <input type="text"
								class="form-control" value="<%out.print(teacher.getTlevel());%>"
								name="slevel"> <br> <label>所属学院</label> <input
								type="text" class="form-control"
								value="<%out.print(teacher.getTdepart());%>" name="tdepart">
							<br>
